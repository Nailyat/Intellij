...
public abstract class Vehicle {
    ...
    String vinNumber;
    static int totalNumberOfVehicls;

    Vehicle(String vinNumber){
        this.vinNumber=vinNumber;
        totalNumberOfVehicls++;
        System.out.println("Vehicle constructor");
    }
   private void display(){
    }
    static void displayTotalVehicles(){
        System.out.println("We build "+totalNumberOfVehicls+" vehicles");
    }
   public void drive(){
...
abstract class Car extends Vehicle{
    ...
    Car(String carType, String vinNumber){
        super(vinNumber); // super call should be first, before this
